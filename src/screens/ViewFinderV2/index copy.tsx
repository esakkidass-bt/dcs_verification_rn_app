...
// const Index = () => {
//   const {onImageCapture} = useStateContext();
...
//     (key: any) => (value: any) => {
//       setImgData((prevData: any) => ({...prevData, [key]: value}));
//     },
//     [],
//   );
...
//   //     const isSubDivisionNumberPresent = selectedFeatures.land?.find(
//   //       e => e.properties?.sub_division_number === null,
//   //     );
//   //     // console.log(d)
//   //     if (isSubDivisionNumberPresent) {
//   //       polygonFeature = isSubDivisionNumberPresent;
//   //     } else {
//   //       const _polygons = selectedFeatures.land.map(
//   //         multiPolygon => turf.flatten(multiPolygon).features,
//   //       );

//   //       // Flatten the array of arrays into a single array
//   //       const flatPolygons = _polygons.flat();
//   //       polygonFeature = await combineSubDivisionNumbers(flatPolygons);
//   //     }
...
//   //     }
//   //   },
//   //   [DISTANCE_ACCURACY_THRESHOLD, selectedFeatures.land],
//   // );
...
//     onImageCapture({
//       image: uri,
//       imgOrientationX: imgData.x,
//       imgOrientationY: imgData.y,
//       imgOrientationZ: imgData.z,
//       imgLat: imgData.lat,
//       imgLon: imgData.lon,
//       imgTimestamp: imgData.timestamp,
//     });
